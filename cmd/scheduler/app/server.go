...
func Setup(ctx context.Context, opts *options.Options, outOfTreeRegistryOptions ...Option) (*schedulerserverconfig.CompletedConfig, *scheduler.Scheduler, error) {
	...
	sched, err := scheduler.New(cc.SchedulerClientSet,
		...
		scheduler.WithPercentageOfFoodsToScore(cc.ComponentConfig.PercentageOfFoodsToScore),
		scheduler.WithFrameworkOutOfTreeRegistry(outOfTreeRegistry),
		scheduler.WithDguestMaxBackoffSeconds(cc.ComponentConfig.DguestMaxBackoffSeconds),
		scheduler.WithDguestInitialBackoffSeconds(cc.ComponentConfig.DguestInitialBackoffSeconds),
