...
apiVersion: scheduler.config.sample.io/v1
...
func (*foo) PreFilter(_ context.Context, _ *framework.CycleState, _ *v1alpha1.Dguest) (*framework.PreFilterResult, *framework.Status) {
	return nil, nil
}
...
func (*foo) Filter(_ context.Context, _ *framework.CycleState, _ *v1alpha1.Dguest, foodInfo *framework.FoodInfo) *framework.Status {
	return nil
}
