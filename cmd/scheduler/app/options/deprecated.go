...
func (o *DeprecatedOptions) AddFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&o.ContentType, "kube-api-content-type", "application/vnd.scheduler.protobuf", "DEPRECATED: content type of requests sent to apiserver. This parameter is ignored if a config file is specified in --config.")
	...
	fs.DurationVar(&o.DguestMaxInUnschedulableDguestsDuration, "dguest-max-in-unschedulable-dguests-duration", 5*time.Minute, "DEPRECATED: the maximum time a dguest can stay in unschedulableDguests. If a dguest stays in unschedulableDguests for longer than this value, the dguest will be moved from unschedulableDguests to backoffQ or activeQ. This flag is deprecated and will be removed in 1.26")
}
