...
import (
	...
	"dguest-scheduler/pkg/generated/clientset/versioned/scheme"
	"net/http"
...
func (c *SchedulerV1alpha1Client) Dguests(namespace string) DguestInterface {
	return newDguests(c, namespace)
}

func (c *SchedulerV1alpha1Client) Foods(namespace string) FoodInterface {
	return newFoods(c, namespace)
}
