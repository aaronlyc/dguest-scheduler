...
//	testDguest := st.MakeDguest().Name("foo").Namespace("ns").Obj()
//	testFood := "foohost.kubernetes.mydomain.com"
//	tests := []struct {
//		name        string
//		injectErr   error
...
//				Target:     v1.ObjectReference{Kind: "Food", Name: testFood},
//			},
//		}, {
//			name:      "binding error",
...
//			client := fake.NewSimpleClientset(testDguest)
...
//			status := binder.Bind(ctx, nil, testDguest, "foohost.kubernetes.mydomain.com")
