...
func (pl *TestScoreWithNormalizePlugin) Score(ctx context.Context, state *framework.CycleState, p *v1alpha1.Dguest, foodName string) (int64, *framework.Status) {
...
func (pl *TestScorePlugin) Score(ctx context.Context, state *framework.CycleState, p *v1alpha1.Dguest, foodName string) (int64, *framework.Status) {
	return setScoreRes(pl.inj)
}
...
func (pl *TestPlugin) Score(ctx context.Context, state *framework.CycleState, p *v1alpha1.Dguest, foodName string) (int64, *framework.Status) {
...
func (pl *TestPlugin) Reserve(ctx context.Context, state *framework.CycleState, p *v1alpha1.Dguest, foodName string) *framework.Status {
	return framework.NewStatus(framework.Code(pl.inj.ReserveStatus), "injected status")
}

func (pl *TestPlugin) Unreserve(ctx context.Context, state *framework.CycleState, p *v1alpha1.Dguest, foodName string) {
}

func (pl *TestPlugin) PreBind(ctx context.Context, state *framework.CycleState, p *v1alpha1.Dguest, foodName string) *framework.Status {
	return framework.NewStatus(framework.Code(pl.inj.PreBindStatus), "injected status")
}

func (pl *TestPlugin) PostBind(ctx context.Context, state *framework.CycleState, p *v1alpha1.Dguest, foodName string) {
}

func (pl *TestPlugin) Permit(ctx context.Context, state *framework.CycleState, p *v1alpha1.Dguest, foodName string) (*framework.Status, time.Duration) {
	return framework.NewStatus(framework.Code(pl.inj.PermitStatus), "injected status"), time.Duration(0)
}

func (pl *TestPlugin) Bind(ctx context.Context, state *framework.CycleState, p *v1alpha1.Dguest, foodName string) *framework.Status {
...
func (pp *TestPermitPlugin) Permit(ctx context.Context, state *framework.CycleState, p *v1alpha1.Dguest, foodName string) (*framework.Status, time.Duration) {
...
func (t TestBindPlugin) Bind(ctx context.Context, state *framework.CycleState, p *v1alpha1.Dguest, foodName string) *framework.Status {
	return nil
}
