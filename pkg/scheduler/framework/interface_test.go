...
func TestPreFilterResultMerge(t *testing.T) {
	tests := map[string]struct {
		...
		"nil receiver empty input": {
			in:   &PreFilterResult{FoodNames: sets.NewString()},
			want: &PreFilterResult{FoodNames: sets.NewString()},
		},
		"empty receiver nil input": {
			receiver: &PreFilterResult{FoodNames: sets.NewString()},
			want:     &PreFilterResult{FoodNames: sets.NewString()},
		},
		...
		"nil receiver populated input": {
			in:   &PreFilterResult{FoodNames: sets.NewString("food1")},
			want: &PreFilterResult{FoodNames: sets.NewString("food1")},
		},
		...
		"populated receiver nil input": {
			receiver: &PreFilterResult{FoodNames: sets.NewString("food1")},
			want:     &PreFilterResult{FoodNames: sets.NewString("food1")},
		},
		...
		"populated receiver and input": {
			receiver: &PreFilterResult{FoodNames: sets.NewString("food1", "food2")},
			in:       &PreFilterResult{FoodNames: sets.NewString("food2", "food3")},
			want:     &PreFilterResult{FoodNames: sets.NewString("food2")},
		},
	}
