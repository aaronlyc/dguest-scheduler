...
var DguestsToActivateKey StateKey = "kubernetes.io/dguests-to-activate"
...
type ScorePlugin interface {
	...
	// the dguest will be rejected.
	Score(ctx context.Context, state *CycleState, p *v1alpha1.Dguest, foodName string) (int64, *Status)
...
type ReservePlugin interface {
	...
	Reserve(ctx context.Context, state *CycleState, p *v1alpha1.Dguest, foodName string) *Status
	...
	Unreserve(ctx context.Context, state *CycleState, p *v1alpha1.Dguest, foodName string)
}
...
type PreBindPlugin interface {
	...
	PreBind(ctx context.Context, state *CycleState, p *v1alpha1.Dguest, foodName string) *Status
}
...
type PostBindPlugin interface {
	...
	PostBind(ctx context.Context, state *CycleState, p *v1alpha1.Dguest, foodName string)
}
...
type PermitPlugin interface {
	...
	Permit(ctx context.Context, state *CycleState, p *v1alpha1.Dguest, foodName string) (*Status, time.Duration)
}
...
type BindPlugin interface {
	...
	Bind(ctx context.Context, state *CycleState, p *v1alpha1.Dguest, foodName string) *Status
}
...
type Framework interface {
	...
	RunPreBindPlugins(ctx context.Context, state *CycleState, dguest *v1alpha1.Dguest, foodName string) *Status

	// RunPostBindPlugins runs the set of configured PostBind plugins.
	RunPostBindPlugins(ctx context.Context, state *CycleState, dguest *v1alpha1.Dguest, foodName string)

	// RunReservePluginsReserve runs the Reserve method of the set of
	// configured Reserve plugins. If any of these calls returns an error, it
	// does not continue running the remaining ones and returns the error. In
	// such case, dguest will not be scheduled.
	RunReservePluginsReserve(ctx context.Context, state *CycleState, dguest *v1alpha1.Dguest, foodName string) *Status

	// RunReservePluginsUnreserve runs the Unreserve method of the set of
	// configured Reserve plugins.
	RunReservePluginsUnreserve(ctx context.Context, state *CycleState, dguest *v1alpha1.Dguest, foodName string)
	...
	RunPermitPlugins(ctx context.Context, state *CycleState, dguest *v1alpha1.Dguest, foodName string) *Status
	...
	// code=5("skip") status.
	RunBindPlugins(ctx context.Context, state *CycleState, dguest *v1alpha1.Dguest, foodName string) *Status
...
type DguestNominator interface {
	...
	NominatedDguestsForFood(foodName string) []*DguestInfo
}
