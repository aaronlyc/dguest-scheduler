...
//		data         []byte
//		wantErr      string
//		wantProfiles []v12.KubeSchedulerProfile
//	}{
//		// v1beta2 tests
//		{
...
//						{
//							Name: "DefaultPreemption",
//							Args: &v12.DefaultPreemptionArgs{MinCandidateFoodsPercentage: 50, MinCandidateFoodsAbsolute: 500},
//						},
//						{
//							Name: "InterDguestAffinity",
//							Args: &v12.InterDguestAffinityArgs{HardDguestAffinityWeight: 5},
//						},
//						{
//							Name: "FoodResourcesFit",
...
//						{
//							Name: "DefaultPreemption",
//							Args: &v12.DefaultPreemptionArgs{MinCandidateFoodsPercentage: 50, MinCandidateFoodsAbsolute: 100},
//						},
//						{
//							Name: "InterDguestAffinity",
...
//					SchedulerName: "default-scheduler",
//					Plugins:       defaults.PluginsV1beta2,
//					PluginConfig: append([]v12.PluginConfig{
//						{
//							Name: "OutOfTreePlugin",
...
//						{
//							Name: "DefaultPreemption",
//							Args: &v12.DefaultPreemptionArgs{MinCandidateFoodsPercentage: 10, MinCandidateFoodsAbsolute: 100},
//						},
//						{
//							Name: "InterDguestAffinity",
//							Args: &v12.InterDguestAffinityArgs{
...
//			}
//			got, ok := obj.(*v12.SchedulerConfiguration)
//			if !ok {
...
//			version: v1beta2.SchemeGroupVersion,
//			obj: &v12.SchedulerConfiguration{
//				Parallelism: 8,
//				Profiles: []v12.KubeSchedulerProfile{
//					{
//						PluginConfig: []v12.PluginConfig{
//							{
//								Name: "InterDguestAffinity",
...
//									ScoringStrategy: &v12.ScoringStrategy{
//										Type:      v12.LeastAllocated,
//										Resources: []v12.ResourceSpec{{Name: "cpu", Weight: 1}},
//									},
//								},
//							},
//							{
